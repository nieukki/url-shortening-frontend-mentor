...
export const Footer = () => {
  ...
  return (
    <footer className="w-full h-80  bg-neutral-veryDarkViolet flex flex-row items-center justify-around py-10">
      ...
      <div className="h-full flex flex-row items-start justify-center gap-10">
        <div>
          <p className="font-medium mb-8 text-white">Features</p>
          <ul className="text-neutral-gray flex flex-col items-start gap-2">
      ...
      <div className="h-full flex flex-row items-start justify-center gap-x-6">
